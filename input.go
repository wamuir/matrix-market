...
var supported = []header{
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_REAL_STR, MM_GENERAL_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_REAL_STR, MM_SYMM_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_REAL_STR, MM_SKEW_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_INT_STR, MM_GENERAL_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_INT_STR, MM_SYMM_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_INT_STR, MM_SKEW_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_COMPLEX_STR, MM_GENERAL_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_COMPLEX_STR, MM_SYMM_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_COMPLEX_STR, MM_SKEW_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_REAL_STR, MM_GENERAL_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_REAL_STR, MM_SYMM_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_REAL_STR, MM_SKEW_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_INT_STR, MM_GENERAL_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_INT_STR, MM_SYMM_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_INT_STR, MM_SKEW_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_COMPLEX_STR, MM_GENERAL_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_COMPLEX_STR, MM_SYMM_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_COMPLEX_STR, MM_SKEW_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_COMPLEX_STR, MM_HERM_STR},
	header{MM_MTX_STR, MM_ARRAY_STR, MM_COMPLEX_STR, MM_HERM_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_PATTERN_STR, MM_GENERAL_STR},
	header{MM_MTX_STR, MM_COORDINATE_STR, MM_PATTERN_STR, MM_SYMM_STR},
}
